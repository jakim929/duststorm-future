...
for m = 1, 12 do begin
    ...
    for d = 1, nday(m-1) do begin
        ...
        SCS = [[90,5,5,21.19,0.68,0.005],[80,5,15,30,0.90,0.01],[65,10,25,44.87,0.85,0.037],[20,15,65,21.79,0.67,0.059],[5,5,90,1,1,1],[40,20,40,17.79,0.61,0.049],[60,25,15,25.79,0.74,0.075],[10,35,55,27.50,0.75,0.110],$
                ...
                for dx = 0, 116 do begin
                    for dy = 0, 110 do begin
                      ...
                      if t_rh gt 1. then t_rh = 1.
                    	...
                    	if stype eq 5 and t_smois gt maxwsilt then maxwsilt = t_smois ;checking max silt water content
                    	...
                    	if t_smois gt t_tsmois then begin
                    	      ;t_mcf = (1+ 1.21*(t_smois - t_tsmois)^0.68)^0.5   ; Soil moisture content correction factor
                    	endif else begin
                    	      t_mcf = float(1)
                    	endelse
                    	t_rcf = 1 ;temporary
