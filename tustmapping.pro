...
data = read_tiff('/home2/sunwoo/output/average_tust_2001.tif') ; read the MP LAI outputs 
...
Tmax = 0.6 ; Setting Coef. maximum value
...
LoadCT, 0, /Silent ; Loading the colobr table for the background
   ...
   XYOutS, 0.5, 0.915, 'Average Threshold Friction Velocity 2001', font=1, charsize=4, Color=FSC_Color('black'), $ ; Putting the Title
         /Normal, Alignment=0.5
      snapshot=tvrd(true=1)
   Write_png, '/home2/sunwoo/avg_tust_2001.png', snapshot ; Save the pop-up window image
;endfor
end
