...
Tmax = 24 ; Setting Coef. maximum value
...
LoadCT, 0, /Silent ; Loading the colobr table for the background
   ...
   XYOutS, 0.5, 0.915, 'Horizontal dust flux (kg/ms) for '+nmon(i)+', 2001', font=1, charsize=4, Color=FSC_Color('black'), $ ; Putting the Title
         /Normal, Alignment=0.5
      snapshot=tvrd(true=1)
   Write_png, '/home2/sunwoo/hdf_'+nmon(i)+'_01.png', snapshot ; Save the pop-up window image
endfor
end
