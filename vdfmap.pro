...
data = read_tiff('/home2/sunwoo/final_output/vdf_average_2001.tif') ; read the MP LAI outputs 
...
Tmax = 1.0*10^(-7) ; Setting Coef. maximum value
...
LoadCT, 0, /Silent ; Loading the colobr table for the background
   ...
   XYOutS, 0.5, 0.915, 'Vertical dust flux (gm-2s-1) for 2001', font=1, charsize=4, Color=FSC_Color('black'), $ ; Putting the Title
         /Normal, Alignment=0.5
      snapshot=tvrd(true=1)
   Write_png, '/home2/sunwoo/vdf_avg_2001', snapshot ; Save the pop-up window image
;endfor
end
