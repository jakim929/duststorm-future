...
data = read_tiff('/home2/sunwoo/final_output/foutput3/tot_SSI_future2.tif') ; read the MP LAI outputs 
...
Tmax = 365 ; Setting Coef. maximum value
...
LoadCT, 0, /Silent ; Loading the colobr table for the background
   ...
   colorbar, NCOLORS=253, POSITION=loc, divisions=5, /vertical, color='black', $; Drawing the color bar
             charsize=1.5, minrange=Tmin, maxrange=Tmax, /right, charthick=2, format='(i0)'
   ...
   XYOutS, 0.5, 0.915, 'Dust Storm Potential Frequency 2081: Case 5', font=1, charsize=4, Color=FSC_Color('black'), $ ; Putting the Title
         /Normal, Alignment=0.5
      snapshot=tvrd(true=1)
   Write_png, '/home2/sunwoo/final_output/coutput1/Dust Storm Potential Frequency 2081 Case 5.png', snapshot ; Save the pop-up window image
;endfor
end
