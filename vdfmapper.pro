...
data = read_tiff('/home2/sunwoo/final_output/foutput1/vdf_yearly_2081.tif') ; read the MP LAI outputs 
...
Tmax = 0.00000024 ; Setting Coef. maximum value
Tmin = 0.0000000 ; Setting Coef. minimum value
...
LoadCT, 0, /Silent ; Loading the colobr table for the background
   ...
   colorbar, NCOLORS=253, POSITION=loc, divisions=5, /vertical, color='black', $; Drawing the color bar
             charsize=1.5, minrange=Tmin, maxrange=Tmax, /right, charthick=2, format='(E7.1)'
   ...
   XYOutS, 0.5, 0.915, 'Yearly Vertical Dust Flux Average (gm-2s-1) for 2081', font=1, charsize=4, Color=FSC_Color('black'), $ ; Putting the Title
         /Normal, Alignment=0.5
      snapshot=tvrd(true=1)
   Write_png, '/home2/sunwoo/final_graphs/vdf_yearly_2081(avg)1.png', snapshot ; Save the pop-up window image
;endfor
end
