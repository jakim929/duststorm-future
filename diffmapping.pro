...
data = read_tiff('/home2/sunwoo/comparison_output/frequency_comp_yearly.tif') ; read the MP LAI outputs 
...
Tmax = 300 ; Setting Coef. maximum value
...
LoadCT, 0, /Silent ; Loading the colobr table for the background
   ...
   XYOutS, 0.5, 0.915, 'Dust Storm Frequency Difference 2001 and 2081', font=1, charsize=4, Color=FSC_Color('black'), $ ; Putting the Title
         /Normal, Alignment=0.5
      snapshot=tvrd(true=1)
   Write_png, '/home2/sunwoo/final_graphs/comparison/Dust Storm Frequency Difference.png', snapshot ; Save the pop-up window image
;endfor
end
